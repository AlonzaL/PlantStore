...
public class TinyDB {
    ...
    public ArrayList<PlantModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PlantModel> playerList = new ArrayList<PlantModel>();

        for (String jObjString : objStrings) {
            PlantModel player = gson.fromJson(jObjString, PlantModel.class);
    ...
    public void putListObject(String key, ArrayList<PlantModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (PlantModel player : playerList) {
